const nameGirl = 'Thanh Tiền';
const giftUrl = '#';
const eventName = 'Chúc Mừng Sinh Nhật';
const titleCard = 'Tặng bro';
const contentCard = 'Chúc bro của tôi sinh nhật tràn ngập niềm vui và hạnh phúc. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
